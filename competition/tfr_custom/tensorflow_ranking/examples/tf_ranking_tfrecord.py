...
flags.DEFINE_enum("data_format", "example_list_with_context",
...
flags.DEFINE_string("vocab_path", None, "Vocabulary path for query and document tokens.")
...
flags.DEFINE_integer("list_size", None, "List size used for training. Use None for dynamic list size.")
flags.DEFINE_integer("group_size", 1, "Group size used in score function.")
flags.DEFINE_string("loss", "approx_ndcg_loss", "The RankingLossKey for the loss function.")
flags.DEFINE_string("weights_feature_name", "", "The name of the feature where unbiased learning-to-rank weights are stored.")
flags.DEFINE_bool("listwise_inference", False, "If true, exports accept `data_format` while serving.")
flags.DEFINE_bool("use_document_interactions", False, "If true, uses cross-document interactions to generate scores.")
flags.DEFINE_integer("embedding_dim", 512, "max size of any query or document")
